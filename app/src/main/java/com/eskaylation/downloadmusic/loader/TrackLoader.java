...
public class TrackLoader extends BaseAsyncTaskLoader<ArrayList<Song>> {
    public String Where = this.selection;
    public String[] datacol = {"_id", "title", "artist", "album", "album_id", "artist_id", "track", "_data", "duration", "year", "composer"};
    public String selection = "is_music != 0";
    public String[] selectionargs = null;
    public SongListenner songListenner;
    public String sortorder = null;

    public TrackLoader(SongListenner songListenner2, Context context) {
        super(context);
        this.songListenner = songListenner2;
    }
    ...
    public ArrayList<Song> loadInBackground() {
        ...
        if (PermissionChecker.checkCallingOrSelfPermission(getContext(), "android.permission.READ_EXTERNAL_STORAGE") == 0) {
            Cursor query = getContext().getContentResolver().query(Media.EXTERNAL_CONTENT_URI, this.datacol, this.Where, this.selectionargs, this.sortorder);
